...
export default function LoginRegister() {
    ...
    return (
        <div className='form-container bg-transparent backdrop-blur-[4px] min-w-[250px] w-[30%] h-[60%] max-h-[390px] flex flex-col items-center rounded-2xl py-4 overflow-x-hidden'>
            {load &&
